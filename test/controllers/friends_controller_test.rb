...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference("Friend.count") do
      post friends_url, params: { friend: { Email: @friend.Email, Id: @friend.Id, Name: @friend.Name, Phone: @friend.Phone } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { Email: @friend.Email, Id: @friend.Id, Name: @friend.Name, Phone: @friend.Phone } }
